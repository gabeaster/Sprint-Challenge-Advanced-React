...
- [DONE] Why would you use class component over function components (removing hooks from the question)?
- [DONE] Name three lifecycle methods and their purposes.
- [DONE] What is the purpose of a custom hook?
- [DONE] Why is it important to test our apps?
...
- [DONE ] Run `npm install` to download dependencies.
- [DONE ] Run the server using `npm start` or `node server.js`.
...
- [DONE ] Class component that fetches data from the server you now have running - the data can be fetched from `http://localhost:5000/api/players`
